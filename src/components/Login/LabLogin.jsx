...
export class LabLogin extends Component {
  render() {
    return (
        ...
        <div className='' >
                <div className='jumbotron col-lg-4 offset-lg-4 form-box'>
                        <h3 className='text-center form-title'>تسجيل المختبر</h3>
                        ...
                        <form dir='rtl' >
                                ...
                                <div className='pb-3'>  مستخدم جديد؟ <Link to='/register/lab' className='links-buttons'>انشاء حساب</Link></div>
                        </form>
                </div>
        </div>
</div>
