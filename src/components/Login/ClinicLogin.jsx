...
export class ClinicLogin extends Component {
  render() {
    return (
        ...
        <div className='' >
                <div className='jumbotron col-lg-4 offset-lg-4 form-box'>
                        <h3 className='text-center form-title'>تسجيل العيادة</h3>
                        ...
                        <form dir='rtl' >
                                ...
                                <div className='pb-3'>  مستخدم جديد؟ <Link to='/register/clinic' className='links-buttons'>إنشاء حساب</Link></div>
                        </form>
                </div>
        </div>
</div>
