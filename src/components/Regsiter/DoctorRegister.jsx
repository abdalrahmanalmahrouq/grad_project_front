    ...
    return (
        ...
        <div className='' >
                <div className='jumbotron col-lg-4 offset-lg-4 form-box'>
                        <h3 className='text-center form-title'>إنشاء حساب الطبيب</h3>
                        ...
                        <form dir='rtl'>
                                ...
                                <br />
                             <div className='pb-3'>   لديك حساب؟ <Link to='/login/doctor' className='links-buttons'>تسجيل الدخول</Link></div>
                        </form>
                </div>
        </div>
</div>
